    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.CharField(blank=True, help_text='User name for accessing Service.', max_length=200, null=True)),
                ('password', models.CharField(blank=True, help_text='Password for accessing Service.', max_length=200, null=True)),
                ('api_key', models.CharField(blank=True, help_text='API key for accessing Service. For PlaceName queries this is your username.', max_length=200, null=True)),
                ...
                ('time_to_live', models.IntegerField(blank=True, default=604800, help_text='Refresh timeof the service in seconds - determines Cache persistence', null=True)),
                ...
                ('layer_typename', models.CharField(help_text='Layer type name to get the service.', max_length=200)),
