...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('query_type', models.CharField(help_text='Type of query (Service / Group / Collection', max_length=200)),
                ('key', models.CharField(help_text='Query key (service_key, group_key, collection_key)', max_length=200)),
